...
const CarDetailsScreen = () => {
  const car = {
    name: "Audi A6",
    price: "40000 KB / day",
    rentalStartDate: "2025-03-11",
    rentalEndDate: "2025-03-15",
    rentalDuration: "4 Days",
    rentalHours: "30 Hours",
    totalAmount: "40000 Pkr",
    ...
    <div className="bg-white p-6 rounded-lg shadow-lg max-w-md mx-auto">
      ...
      <div className="space-y-4">
        <div className="flex justify-between">
          ...
          <span className="text-gray-900 font-semibold">{car.rentalStartDate}</span>
        </div>
        <div className="flex justify-between">
          <span className="text-gray-700">Rental End Date</span>
          <span className="text-gray-900 font-semibold">{car.rentalEndDate}</span>
        </div>
        <div className="flex justify-between">
          <span className="text-gray-700">Rental Duration</span>
          <span className="text-gray-900 font-semibold">{car.rentalDuration}</span>
        </div>
        <div className="flex justify-between">
          <span className="text-gray-700">Rental Hours</span>
          <span className="text-gray-900 font-semibold">{car.rentalHours}</span>
        </div>
      </div>
      ...
      <div className="mt-6 pt-4 border-t border-gray-200">
        <div className="flex justify-between">
          ...
          <span className="text-lg font-bold text-gray-800">{car.totalAmount}</span>
        </div>
      </div>
