...
const InvoiceDashboard = () => {
  ...
  const fetchInvoices = async () => {
    ...
    try {
      ...
      setError(error.response?.data?.message || "Failed to fetch invoices. Using dummy data instead.");
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 sm:p-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8 text-center sm:text-left">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Invoice Dashboard</h1>
            <p className="text-gray-600">Manage and view all your invoices in one place</p>
            {useDummyData && (
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-100">
                    <tr>
                      {["Date", "Status", "Invoice ID", "Client", "Car Name", "Rental Amount (PKR)", "Actions"].map((header) => (
                        <th
                          key={header}
                          scope="col"
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredData.length > 0 ? (
                      filteredData.map((invoice) => (
                        <tr key={invoice.bookingId} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            {sessionStorage.getItem("name") || "N/A"}
                          </td>
